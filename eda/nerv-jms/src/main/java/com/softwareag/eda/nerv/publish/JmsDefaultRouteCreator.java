...
public class JmsDefaultRouteCreator implements EventPublishListener {
	...
	@Override
	public void prePublish(Event event) {
		/*
		 ...
		 * 3. If the route does not exist - create it.
		 * 4. Decide when/where to register the default JMS component.
		 */
	...
	@Override
	public void postPublish(Event event) {
		// Nothing to do here.
	}
